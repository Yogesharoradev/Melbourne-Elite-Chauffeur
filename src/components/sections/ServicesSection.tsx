...
const services = [
    {
        ...
        icon: CarFront,
        inquiryMessage: "Hi, I'm interested in VIP Transport service. Can you provide more details?"
    },
    {
        ...
        icon: Plane,
        inquiryMessage: "Hi, I need an airport transfer. Please share pricing and availability."
    },
    {
        ...
        icon: Briefcase,
        inquiryMessage: "Hi, I'm looking for corporate hire services. Can you help?"
    },
    {
        ...
        icon: GlassWater,
        inquiryMessage: "Hi, I need luxury transport for a wedding/event. Please share options."
    },
];
                            ...
                            <Card className="group overflow-hidden bg-background/50 hover:bg-background border-border/50 hover:border-primary/50 transition-all duration-500 h-full">
                                <CardContent className="p-8 flex flex-col md:flex-row gap-6 items-start">
                                    ...
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <Button
                                            onClick={() => openWhatsAppChat(service.inquiryMessage)}
                                            variant="link"
                                            className="p-0 cursor-pointer text-primary hover:text-primary/80 group-hover:translate-x-2 transition-transform h-auto"
                                        >
